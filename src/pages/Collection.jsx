...
const Collection = () => {
  ...
  // when ther is no category and subcategory then setFilterProducts(products), 
  // so no need to separately write useEffect for initial showing all products.  
      ...
      <div className='flex-1'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 gap-y-6'>
          ...
          {filterProducts.map((item,index)=>(
            <ProductItem id={index} name={item.name} image={item.image} price={item.price} />
          ))}
