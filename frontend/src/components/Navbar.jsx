...
const Navbar = () => {
    ...
    const {setShowSearch,calCartCount,token,setToken,navigate,setCartItems} =useContext(ShopContext)
    const logout =()=>{
  ...
  return (
    ...
    <div className="flex items-center gap-6">
        ...
        <Link to="/cart" className="relative">
            ...
            <p className="absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]">{calCartCount()}</p>
        </Link>
